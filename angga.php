...
echo color("yellow","[•] Isi dengan awalan 62xxxx \n");
echo color("red","# # # # # # # # # # # # # # # # # # # # # # # \n");
function change(){
        $nama = nama();
        ...
        $no = trim(fgets(STDIN));
        $data = '{"email":"'.$email.'@angga.com","name":"'.$nama.'","phone":"+'.$no.'","signed_up_country":"ID"}';
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-XMBM3SG"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai')){
        echo "\n".color("green","+] Message: ".$message);
        goto gofood;
        ...
        $expired6 = getStr1('"expiry_date":"','"',$cekvoucher,'6');
         ...
         echo color("red","========( PIN ANDA = 909090 )========")."\n";
         $data2 = '{"pin":"909090"}';
